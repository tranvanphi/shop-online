            ...
            <table class="js-table-checkable table table-hover">
                ...
                ?>
                    <tr>
                        ...
                        <td class="hidden-xs">
                            <?php echo $value->name_group?>
                        </td>
                        <td class="text-center">
                            <div class="btn-group">
                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Chỉnh sửa"><a href="<?php echo Admin_url('admin/formAction/'.$value->id);?>"><i class="fa fa-pencil"></i></a></button>
                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove Client"><a href="<?php echo Admin_url('admin/delete/'.$value->id);?>"><i class="fa fa-times"></i></a></button>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach;?>
