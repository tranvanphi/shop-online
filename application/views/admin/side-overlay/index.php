<div id="side-overlay-scroll">
                    ...
                    <div class="side-header side-content">
                        ...
                        <span>
                            <img class="img-avatar img-avatar32" src="<?php echo PUBLIC_URL('admin')?>assets/img/avatars/avatar10.jpg" alt="">
                            <span class="font-w600 push-10-l">Bruce Edwards</span>
                        </span>
                    </div>
                    <!-- END Side Header -->
                                            ...
                                            <ul class="nav-users remove-margin-b">
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo PUBLIC_URL('admin')?>assets/img/avatars/avatar1.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo PUBLIC_URL('admin')?>assets/img/avatars/avatar13.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo PUBLIC_URL('admin')?>assets/img/avatars/avatar2.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo PUBLIC_URL('admin')?>assets/img/avatars/avatar6.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo PUBLIC_URL('admin')?>assets/img/avatars/avatar10.jpg" alt="">
                                                        <i class="fa fa-circle text-warning"></i> Walter Fox
