...
<div class="content content-boxed">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6">
            <a class="block block-link-hover3 text-center" href="<?php echo Admin_url('user/formAction')?>">
                <div class="block-content block-content-full">
                    <div class="h1 font-w700 text-success"><i class="fa fa-plus"></i></div>
                </div>
                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Thêm tài khoản</div>
            </a>
        </div>
    ...
    <div class="block">
        <div class="block-content">
            <form class="list_filter form" action="<?php echo Admin_url('user/search')?>" method="post">
                <table class="table table-header-bg">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <input type="reset" class="btn btn-success" value="Reset" onclick="window.location.href = '<?php echo Admin_url('user/index')?>'; ">
                            </td>   
                        </tr>
            ...
            <table class="js-table-checkable table table-hover">
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Client"><a href="<?php echo Admin_url('user/formAction/'.$value->id);?>"><i class="fa fa-pencil"></i></a></button>
                                <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove Client"><a href="<?php echo Admin_url('user/delete/'.$value->id);?>"><i class="fa fa-times"></i></a></button>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach;?>
