...
<div class="box-right">
    ...
    <div class="content-box">
        ...
        <div class="support">
			...
			<p><img style="margin-bottom:-3px" src="<?php echo PUBLIC_URL('site')?>images/phone.png"> 01686039488</p>
			<p>
	...
	<div class="content-box">
	   	<ul class="news">
	        ...
	        <li>
	            ...
	            <img src="<?php echo base_url('uploads/news/').$row->image_link;?>" style="width:50px;"><?php echo $row->title;?>
	            </a>
	        </li>
	        <?php endforeach;?>
	    </ul>
...
<div class="box-right">
    ...
    <div class="content-box">     
        <iframe src="http://www.facebook.com/plugins/likebox.php?href=https://www.facebook.com/nobitacnt&amp;width=190&amp;height=300&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color&amp;header=true" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:300px;" allowtransparency="true"></iframe>   
    </div>
</div>
<!-- End Fanpage -->
...
<div class="box-right">
    ...
    <div class="content-box">
		...
		</script><div id="histats_counter_1523" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_1523_canvas" width="119" height="81"></canvas></a></div></a>
